...
{
    /// <summary>
    /// Classe base per la creazione dei comandi Bindabili
    /// </summary>
    public static class EventBehaviourFactory
    {
        ...
        {
            DependencyProperty property = DependencyProperty.RegisterAttached(propertyName, typeof(ICommand), ownerType, new PropertyMetadata(null, new ExecuteCommandOnRoutedEventBehaviour(routedEvent).PropertyChangedHandler));
